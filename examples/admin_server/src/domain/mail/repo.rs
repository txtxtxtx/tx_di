...
pub struct MailLogModel {
    ...
    pub send_status: String, #[default("".to_string())] pub send_message_id: String, #[default("".to_string())] pub send_exception: String,
    #[default("".to_string())] pub creator: String, #[default("".to_string())] pub updater: String,
    #[default(jiff::Timestamp::now())] pub created_at: jiff::Timestamp,
    #[update(jiff::Timestamp::now())] pub updated_at: jiff::Timestamp,
    #[default(0u8)] pub deleted: u8,
...
fn str_to_send_status(s: &str) -> MailSendStatus { match s { "success" => MailSendStatus::Success, "failed" => MailSendStatus::Failed, _ => MailSendStatus::Init } }
