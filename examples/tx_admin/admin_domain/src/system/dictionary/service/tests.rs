...
mod dict_type_service_tests {
    use crate::system::dictionary::model::aggregate::DictType;
    use crate::system::dictionary::model::value_object::DictTypeQuery;
    use crate::system::dictionary::repository::DictTypeRepository;
    use crate::system::dictionary::service::DictTypeService;
...
mod dict_data_service_tests {
    use crate::system::dictionary::model::aggregate::DictData;
    use crate::system::dictionary::model::value_object::DictDataQuery;
    use crate::system::dictionary::repository::DictDataRepository;
    use crate::system::dictionary::service::DictDataService;
    use crate::shared::model::AuditFields;
    use async_trait::async_trait;
    use pretty_assertions::assert_eq;
    ...
    async fn test_create_dict_data_insert_error() {
        let mut repo = TestDictDataRepo::new();
        repo.insert_fn =
            Box::new(|_| Err(crate::system::dictionary::repository::DictionaryRepositoryError::DatabaseDict.into()));
