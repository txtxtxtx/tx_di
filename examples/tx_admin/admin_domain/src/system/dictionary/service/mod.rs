...
use crate::system::dictionary::repository::{DictDataRepository, DictTypeRepository};
use crate::system::dictionary::repository::DictionaryRepositoryError;
use tx_common::id;
...
impl DictTypeService {
    ...
    pub async fn create_dict_type(
        ...
        if self.dict_type_repo.exists_by_type(&dict_type).await? {
            Err(DictionaryRepositoryError::DuplicateDictType)?;
        }
        let id = id::next_id();
    ...
    pub async fn update_dict_type(
        ...
        let mut dt = self
            ...
            .find_by_id(id)
            .await?
            .ok_or(DictionaryRepositoryError::NotFoundDict)?;
