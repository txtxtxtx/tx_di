...
mod dict_tests {
    ...
    fn test_create_dict_type_raises_event() {
        ...
        assert!(matches!(
            dt.events()[0],
            DictionaryEvent::DictTypeCreated { dict_type_id: 2 }
        ));
    }
    ...
    fn test_update_dict_type_raises_event() {
        ...
        assert!(matches!(
            dt.events().last(),
            Some(DictionaryEvent::DictTypeUpdated { dict_type_id: 1 })
        ));
    }
    ...
    fn test_dict_type_soft_delete_raises_event() {
        ...
        assert!(matches!(
            dt.events().last(),
            Some(DictionaryEvent::DictTypeDeleted { dict_type_id: 1 })
        ));
    }
    ...
    fn test_create_dict_data_raises_event() {
        ...
        assert!(matches!(
            dd.events()[0],
            DictionaryEvent::DictDataCreated { dict_data_id: 200 }
        ));
    }
    ...
    fn test_update_dict_data_raises_event() {
        ...
        assert!(matches!(
            dd.events().last(),
            Some(DictionaryEvent::DictDataUpdated { dict_data_id: 100 })
        ));
    }
    ...
    fn test_dict_data_soft_delete_raises_event() {
        ...
        assert!(matches!(
            dd.events().last(),
            Some(DictionaryEvent::DictDataDeleted { dict_data_id: 100 })
        ));
    }
    ...
    fn test_dict_type_restore_no_events() {
        ...
        let dt = DictType::restore(1, "N".into(), "t".into(), 0, None, AuditFields::default());
