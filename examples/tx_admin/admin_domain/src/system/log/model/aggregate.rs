...
use crate::system::log::model::event::LogEvent;

/// Operate log aggregate root
#[derive(Debug, Clone, Serialize, Deserialize, AggregateRoot)]
#[aggregate_root(event = crate::system::log::model::event::LogEvent)]
...
impl OperateLog {
    ...
    pub fn create(
        ...
        log.add_event(LogEvent::OperateLogCreated { log_id: id });
        log
    }
...
impl LoginLog {
    ...
    pub fn create(
        ...
        log.add_event(LogEvent::LoginLogCreated { log_id: id });
        log
    }
}
