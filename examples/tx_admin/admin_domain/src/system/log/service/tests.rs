...
mod operate_log_service_tests {
    use crate::system::log::model::aggregate::OperateLog;
    use crate::system::log::model::value_object::OperateLogQuery;
    use crate::system::log::repository::OperateLogRepository;
    use crate::system::log::service::OperateLogService;
    ...
    struct TestOperateLogRepo {
        ...
        find_page_fn: Box<
            dyn Fn(&OperateLogQuery, Page<OperateLog>) -> AppResult<Page<OperateLog>> + Send + Sync,
        >,
    ...
    async fn test_create_operate_log_insert_error() {
        let mut repo = TestOperateLogRepo::new();
        repo.insert_fn =
            Box::new(|_| Err(crate::system::log::repository::LogRepositoryError::DatabaseLog.into()));
...
mod login_log_service_tests {
    use crate::system::log::model::aggregate::LoginLog;
    use crate::system::log::model::value_object::LoginLogQuery;
    use crate::system::log::repository::LoginLogRepository;
    use crate::system::log::service::LoginLogService;
    use crate::shared::model::AuditFields;
    use async_trait::async_trait;
    use jiff::Timestamp;
    use pretty_assertions::assert_eq;
    ...
    struct TestLoginLogRepo {
        ...
        find_page_fn:
            Box<dyn Fn(&LoginLogQuery, Page<LoginLog>) -> AppResult<Page<LoginLog>> + Send + Sync>,
