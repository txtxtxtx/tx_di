...
mod file_service_tests {
    use crate::system::file::model::aggregate::{File, FileConfig};
    use crate::system::file::model::value_object::{FileQuery, FileUploadCommand};
    use crate::system::file::repository::{FileConfigRepository, FileRepository};
    use crate::system::file::service::FileService;
    use crate::system::file::model::event::FileEvent;
    ...
    async fn test_upload_file_insert_error() {
        let mut file_repo = TestFileRepo::new();
        file_repo.insert_fn =
            Box::new(|_| Err(crate::system::file::repository::FileRepositoryError::DatabaseFile.into()));
        let config_repo = TestFileConfigRepo::new();
    ...
    async fn test_upload_file_raises_event() {
        ...
        assert!(matches!(file.events()[0], FileEvent::FileUploaded { .. }));
    }
    ...
    async fn test_get_file_page_error() {
        ...
        file_repo.find_page_fn =
            Box::new(|_, _| Err(crate::system::file::repository::FileRepositoryError::DatabaseFile.into()));
        let config_repo = TestFileConfigRepo::new();
    ...
    async fn test_resolve_config_id_db_error() {
        ...
        config_repo.find_master_fn =
            Box::new(|| Err(crate::system::file::repository::FileRepositoryError::DatabaseFile.into()));
