...
mod file_tests {
    ...
    fn make_file() -> File {
        File::create(
            ...
            "https://cdn.example.com/test.png".into(),
            Some("image/png".into()),
            1024,
            Some("admin".into()),
        )
    ...
    fn test_create_file_raises_event() {
        ...
        assert!(matches!(
            f.events()[0],
            FileEvent::FileUploaded { file_id: 1 }
        ));
    }
    ...
    fn test_file_restore_preserves_all_fields() {
        ...
        let f = File::restore(
            ...
            Some(7),
            "photo.jpg".into(),
            "/store/photo.jpg".into(),
            "https://cdn.example.com/photo.jpg".into(),
    ...
    fn test_file_soft_delete_raises_event() {
        ...
        assert!(matches!(
            f.events().last(),
            Some(FileEvent::FileDeleted { file_id: 1 })
        ));
    }
    ...
    fn test_file_soft_delete_twice_accumulates_events() {
        ...
        assert!(matches!(
            f.events()[1],
            FileEvent::FileDeleted { file_id: 1 }
        ));
        assert!(matches!(
            f.events()[2],
            FileEvent::FileDeleted { file_id: 1 }
    ...
    fn test_file_add_event_directly() {
        ...
        f.add_event(FileEvent::FileUploaded { file_id: 1 });
        assert_eq!(f.events().len(), 1);
    }
    ...
    fn test_file_config_clear_events() {
        ...
        fc.add_event(FileEvent::FileUploaded { file_id: 1 });
    ...
    fn test_file_config_add_event() {
        ...
        fc.add_event(FileEvent::FileDeleted { file_id: 100 });
        assert_eq!(fc.events().len(), 1);
        assert!(matches!(
            fc.events()[0],
            FileEvent::FileDeleted { file_id: 100 }
        ));
    }
