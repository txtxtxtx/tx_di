...
#[aggregate_root(event = crate::system::file::model::event::FileEvent)]
pub struct File {
    pub id: u64,
...
impl File {
    ...
    pub fn create(
        ...
        file.add_event(FileEvent::FileUploaded { file_id: id });
        file
    }
    ...
    pub fn soft_delete(&mut self, updater: Option<String>) {
        ...
        self.add_event(FileEvent::FileDeleted { file_id: self.id });
    }
}
