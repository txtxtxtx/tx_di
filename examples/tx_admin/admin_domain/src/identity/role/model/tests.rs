...
mod role_tests {
    ...
    fn test_create_role_raises_event() {
        ...
        assert!(matches!(
            role.events()[0],
            RoleEvent::RoleCreated { role_id: 100 }
        ));
    }
    ...
    fn test_update_info_raises_event() {
        ...
        assert!(matches!(
            role.events().last(),
            Some(RoleEvent::RoleUpdated { role_id: 100 })
        ));
    }
    ...
    fn test_set_menus_raises_event() {
        ...
        assert!(matches!(
            role.events().last(),
            Some(RoleEvent::RolePermissionsChanged { role_id: 100 })
        ));
    }
    ...
    fn test_soft_delete_raises_event() {
        ...
        assert!(matches!(
            role.events().last(),
            Some(RoleEvent::RoleDeleted { role_id: 100 })
        ));
    }
