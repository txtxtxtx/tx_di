...
mod user_service_tests {
    ...
    use crate::identity::user::model::value_object::{UserQuery, UserStatus};
    use crate::identity::user::service::UserService;
    ...
    async fn test_update_user_success() {
        ...
        let r = svc
            .update_user(
                ...
                None,
                None,
                crate::identity::user::model::value_object::Sex::Unknown,
                None,
                None,
            )
            .await;
    ...
    async fn test_get_user_page_success() {
        ...
        let svc = UserService::new(Arc::new(repo));
        let query = crate::identity::user::model::value_object::UserQuery::default();
