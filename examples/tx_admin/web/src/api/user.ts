...
export function createUser(data: CreateUserRequest) {
  return request.post<ApiRes<UserResponse>>('/api/v1/user', data).then(r => r.data)
}
...
export function listUsers(data: ListUsersRequest) {
  return request.post<ApiRes<PageData<UserResponse>>>('/api/v1/user/list', data).then(r => r.data)
}

export function changePassword(data: ChangePasswordRequest) {
  return request.post<ApiRes<null>>('/api/v1/user/change_password', data).then(r => r.data)
}

export function assignRoles(data: AssignRolesRequest) {
  return request.post<ApiRes<null>>('/api/v1/user/assign_roles', data).then(r => r.data)
}

export function assignDepts(data: AssignDeptsRequest) {
  return request.post<ApiRes<null>>('/api/v1/user/assign_depts', data).then(r => r.data)
}

export function enableUser(data: UserIdRequest) {
  return request.post<ApiRes<null>>('/api/v1/user/enable', data).then(r => r.data)
}

export function disableUser(data: UserIdRequest) {
  return request.post<ApiRes<null>>('/api/v1/user/disable', data).then(r => r.data)
}

export function lockUser(data: UserIdRequest) {
  return request.post<ApiRes<null>>('/api/v1/user/lock', data).then(r => r.data)
}

export function unlockUser(data: UserIdRequest) {
  return request.post<ApiRes<null>>('/api/v1/user/unlock', data).then(r => r.data)
}
