...
mod common;
use admin_proto::{CreateDeptRequest, ListDeptsRequest, UpdateDeptRequest};
    ...
    let updated = app
        .update_dept(
            UpdateDeptRequest {
                ...
                parent_id: 0,
                sort: 1,
                leader_user_id: Some(1),
                phone: Some("010-12345678".into()),
    ...
    let updated = app
        .update_dept(
            UpdateDeptRequest {
                ...
                parent_id: 10,
                sort: 20,
                leader_user_id: Some(5),
                phone: Some("010-999".into()),
...
async fn delete_department() {
    ...
    let dept = app
        ...
        .await
        .unwrap();
    app.delete_dept(dept.id, Some("admin".into()))
        .await
        .unwrap();
...
async fn get_dept_tree() {
    ...
    let tree = app
        .get_dept_tree(ListDeptsRequest {
            name: None,
            status: None,
        })
        .await
...
async fn get_dept_list_flat() {
    ...
    let list = app
        .get_dept_list(ListDeptsRequest {
            name: None,
            status: None,
        })
        .await
