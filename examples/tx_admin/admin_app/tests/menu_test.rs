...
mod common;
use admin_proto::{CreateMenuRequest, ListMenusRequest, UpdateMenuRequest};
    ...
    let menu = app
        .create_menu(
            CreateMenuRequest {
                ...
                component: None,
                component_name: Some("System".into()),
            },
            Some("admin".into()),
        )
        .await
    ...
    let menu = app
        .create_menu(
            CreateMenuRequest {
                ...
                icon: Some("user".into()),
                component: Some("system/user/index".into()),
                component_name: Some("UserManagement".into()),
            },
            Some("admin".into()),
        )
        .await
...
async fn create_menu_button() {
    ...
    let menu = app
        .create_menu(
            CreateMenuRequest {
                name: "新增用户".into(),
                permission: "system:user:create".into(),
                types: 2,
                sort: 1,
                parent_id: 2,
                path: None,
                icon: None,
                component: None,
                component_name: Some("UserCreate".into()),
            },
            Some("admin".into()),
        )
        .await
...
async fn create_menu_hierarchy() {
    ...
    let child = app
        .create_menu(
            CreateMenuRequest {
                name: "用户".into(),
                permission: "sys:user".into(),
                types: 1,
                sort: 1,
                parent_id: parent.id,
                path: Some("/sys/user".into()),
                icon: Some("user".into()),
                component: Some("sys/user/index".into()),
                component_name: Some("SysUser".into()),
            },
            Some("admin".into()),
        )
        .await
...
async fn delete_menu() {
    ...
    let menu = app
        ...
        .await
        .unwrap();
    app.delete_menu(menu.id, Some("admin".into()))
        .await
        .unwrap();
}
...
async fn get_menu_tree() {
    ...
    app.create_menu(
        CreateMenuRequest {
            name: "角色管理".into(),
            permission: "system:role:list".into(),
            types: 1,
            sort: 2,
            parent_id: root.id,
            path: Some("/system/role".into()),
            icon: Some("peoples".into()),
            component: Some("system/role/index".into()),
            component_name: Some("Role".into()),
        },
        Some("admin".into()),
    )
    .await
    ...
    let tree = app
        .get_menu_tree(ListMenusRequest {
            name: None,
            status: None,
            types: None,
        })
...
async fn get_menu_list_flat() {
    ...
    let list = app
        .get_menu_list(ListMenusRequest {
            name: None,
            status: None,
            types: None,
        })
