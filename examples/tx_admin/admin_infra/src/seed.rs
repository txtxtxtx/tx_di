...
const MENU_SEEDS: &[(i64, &str, &str, i32, i32, i64, &str, &str, &str, &str, i32, i32)] = &[
    ...
    // ── 文件管理 (顶层菜单, 4位) ──
    (1500, "文件管理", "file:view", 1, 5, 0, "file", "FolderOpened", "file/index", "File", 0, 0),
    (15000001, "上传文件", "file:upload", 2, 1, 1500, "", "", "", "", 0, 0),
    (15000002, "删除文件", "file:delete", 2, 2, 1500, "", "", "", "", 0, 0),
    (15000003, "下载文件", "file:download", 2, 3, 1500, "", "", "", "", 0, 0),
    (15000004, "查看文件", "file:view", 2, 4, 1500, "", "", "", "", 0, 0),
